...
public class OrderEventPublisher implements OrderEventPort {
    ...
    public void orderConfirmed(Order order) {
        afterCommit(() -> rabbit.convertAndSend(RabbitTopics.ORDER_EXCHANGE, RabbitTopics.RK_ORDER_CONFIRMED,
    ...
    public void orderCancelled(Order order, String reason) {
        afterCommit(() -> rabbit.convertAndSend(RabbitTopics.ORDER_EXCHANGE, RabbitTopics.RK_ORDER_CANCELLED,
    ...
    public void orderShipped(Order order) {
        afterCommit(() -> rabbit.convertAndSend(RabbitTopics.ORDER_EXCHANGE, RabbitTopics.RK_ORDER_SHIPPED,
    ...
    public void orderDelivered(Order order) {
        afterCommit(() -> rabbit.convertAndSend(RabbitTopics.ORDER_EXCHANGE, RabbitTopics.RK_ORDER_DELIVERED,
